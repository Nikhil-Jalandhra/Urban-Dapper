  ...
  return (
    <div>
       <div className="ourStoryContainer">
            <h1 className="ourStoryHeading text-primary">Our Story</h1>
            <div className="ourStoryParaContainer">
                ...
                <p className="ourStoryPara">
                we redefine men's fashion through innovation and meticulous attention to detail. Our commitment to quality craftsmanship and seamless user experience reflects in every garment. Step into style with confidence - experience the essence of sophistication with
